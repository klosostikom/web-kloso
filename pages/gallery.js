            ...
            <section className="room-area r-padding1">
                ...
                <div className="row">
                    ...
                    <div className="single-room mb-50">
                        ...
                        <img height="275px" src="assets/img/gallery/Mikrotik Jaringan.jpg" alt />
                        </div>
                    </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div className="single-room mb-50">
                        <div className="room-img">
                        <img height="275px" src="assets/img/gallery/gallery2.JPG" alt />
                        </div>
                    </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div className="single-room mb-50">
                        <div className="room-img">
                        <img height="275px" src="assets/img/gallery/Materi (1).jpg" alt />
                        </div>
                    </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div className="single-room mb-50">
                        <div className="room-img">
                        <img height="275px" src="assets/img/gallery/pelatihan.jpg" alt />
                        </div>
                    </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div className="single-room mb-50">
                        <div className="room-img">
                        <img height="275px" src="assets/img/gallery/Sambutan Pembina UKM K.L.O.S.O.jpg" alt />
                        </div>
                    </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div className="single-room mb-50">
                        <div className="room-img">
                        <img height="275px" src="assets/img/gallery/proker2.jpg" alt />
                        </div>
                    </div>
                    </div>
                </div>
                <div className="row justify-content-center">
                    ...
                    <a href="https://www.instagram.com/kloso_stikombwi/" className="btn view-btn1">View more  <i className="ti-angle-right" /> </a>
                    </div>
                </div>
                </div>
            </section>
