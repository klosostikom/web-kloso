      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="single-room mb-50">
              <div className="room-img">
                <a href="/gallery">
                  <img src="assets/img/rooms/Banner.png" height="235px" alt />
                </a>
              </div>
          ...
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="single-room mb-50">
              <div className="room-img">
                <a href="/gallery">
                  <img
                    src="assets/img/rooms/fullstack(1).png"
                    height="235px"
                    alt
                  />
                </a>
              ...
              <div className="room-caption">
                <h3>
                  <a href="/gallery">Pelatihan Fullstack Developer</a>
                </h3>
                <div className="per-night">
                  <span>
          ...
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="single-room mb-50">
              ...
              <div className="room-caption">
                <h3>
                  <a href="/gallery">Out Bond Dies Natalies UKM</a>
                </h3>
                <div className="per-night">
                  <span>
        ...
        <div className="row justify-content-center">
          <div className="room-btn pt-70">
            <a href="/about" className="btn view-btn1">
